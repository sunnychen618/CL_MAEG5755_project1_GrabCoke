...
void set_example_object_frames(geometry_msgs::PoseStamped &object_poseStamped,
    ...
    object_poseStamped.pose.position.x =  0.8000;
    object_poseStamped.pose.position.y = -0.000;
    object_poseStamped.pose.position.z =  0.8500; //-0.125; //pose w/rt world frame
